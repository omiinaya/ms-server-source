...
public class ItemData {
        ...
        for (String subMap : subMaps) {
            ...
            for (File file : files) {
                ...
                for (Node mainNode : nodes) {
                    ...
                    if (mainName != null) {
                        int itemId = parseInt(attributes.get("name").replace(".img", ""));
                        ...
                        for (Node n : XMLApi.getAllChildren(XMLApi.getFirstChildByNameBF(mainNode, "info"))) {
                            ...
                            switch (name) {
                                ...
                                case "IUCMax":
                                    ...
                                    break;
                                case "setItemID":
                                    equip.setSetItemID(parseInt(value));
                                    break;
                                case "price":
                                    equip.setPrice(parseInt(value));
                                    break;
                                case "attackSpeed":
                                    equip.setAttackSpeed(parseInt(value));
                                    break;
                                case "cash":
                                    equip.setCash(parseInt(value) != 0);
                                    break;
                                case "expireOnLogout":
                                    equip.setExpireOnLogout(parseInt(value) != 0);
                                    break;
                                case "exItem":
                                    equip.setExItem(parseInt(value) != 0);
                                    break;
                                case "notSale":
                                    equip.setNotSale(parseInt(value) != 0);
                                    break;
                                case "only":
                                    equip.setOnly(parseInt(value) != 0);
                                    break;
                                case "tradeBlock":
                                    equip.setTradeBlock(parseInt(value) != 0);
                                    break;
                                case "fixedPotential":
                                    equip.setFixedPotential(parseInt(value) != 0);
                                    break;
                                case "noPotential":
                                    equip.setNoPotential(parseInt(value) != 0);
                                    break;
                                case "bossReward":
                                    equip.setBossReward(parseInt(value) != 0);
                                    break;
                                case "superiorEqp":
                                    equip.setSuperiorEqp(parseInt(value) != 0);
                                    break;
                                case "reduceReq":
                                    equip.setiReduceReq(Short.parseShort(value));
                                    break;
                                case "fixedGrade":
                                    equip.setFixedGrade(parseInt(value));
                                    break;
                                case "specialGrade":
                                    equip.setSpecialGrade(parseInt(value));
                                    break;
                                case "charmEXP":
                                    equip.setCharmEXP(parseInt(value));
                                    break;
                                case "level":
                                            ...
                                            if (case1 != null) {
                                                ...
                                                if (equipmentSkill != null) {
                                                    for (Node equipSkill : XMLApi.getAllChildren(equipmentSkill)) {
                                                        ...
                                                        equip.addItemSkill(new ItemSkill(parseInt(idAttr.get("value")), Byte.parseByte(levelAttr.get("value"))));
                                                    }
                                                }
                                            }
                                        }
                                ...
                                case "option":
                                    for (Node whichOptionNode : XMLApi.getAllChildren(n)) {
                                        ...
                                        int index = parseInt(attributes.get("name"));
                                        ...
                                        options.set(index, parseInt(optionAttr.get("value")));
                                    }
                                    break;
                                case "android":
                                    equip.setAndroid(parseInt(value));
                                    break;
                                case "grade":
                                    equip.setAndroidGrade(parseInt(value));
                                    break;
                            }
    ...
    public static void loadPetsFromWZ() {
        ...
        for (File file : petDir.listFiles()) {
            ...
            int id = parseInt(file.getName().replace(".img.xml", ""));
            ...
            for (Node node : XMLApi.getAllChildren(infoNode)) {
                ...
                switch (name) {
                    ...
                    case "noHungry":
                        break;
                    case "life":
                        pi.setLife(parseInt(value));
                        break;
                    case "setItemID":
                        pi.setSetItemID(parseInt(value));
                        break;
                    case "evolutionID":
                        pi.setEvolutionID(parseInt(value));
                        break;
                    case "type":
                        pi.setType(parseInt(value));
                        break;
                    case "limitedLife":
                        pi.setLimitedLife(parseInt(value));
                        break;
                    case "evol1":
                        pi.setEvol1(parseInt(value));
                        break;
                    case "evol2":
                        pi.setEvol2(parseInt(value));
                        break;
                    case "evol3":
                        pi.setEvol3(parseInt(value));
                        break;
                    case "evol4":
                        pi.setEvol4(parseInt(value));
                        break;
                    case "evol5":
                        pi.setEvol5(parseInt(value));
                        break;
                    case "evolProb1":
                        pi.setProbEvol1(parseInt(value));
                        break;
                    case "evolProb2":
                        pi.setProbEvol2(parseInt(value));
                        break;
                    case "evolProb3":
                        pi.setProbEvol3(parseInt(value));
                        break;
                    case "evolProb4":
                        pi.setProbEvol4(parseInt(value));
                        break;
                    case "evolProb5":
                        pi.setProbEvol5(parseInt(value));
                        break;
                    case "evolReqItemID":
                        pi.setEvolReqItemID(parseInt(value));
                        break;
                    case "evolReqPetLvl":
                        pi.setEvolReqPetLvl(parseInt(value));
                        break;
                    case "evolNo":
                        pi.setEvolNo(parseInt(value));
                        break;
                    case "permanent":
                        pi.setPermanent(parseInt(value) != 0);
                        break;
                    case "pickupItem":
                        pi.setPickupItem(parseInt(value) != 0);
                        break;
                    case "interactByUserAction":
                        pi.setInteractByUserAction(parseInt(value) != 0);
                        break;
                    case "longRange":
                        pi.setLongRange(parseInt(value) != 0);
                        break;
                    case "giantPet":
                        pi.setGiantPet(parseInt(value) != 0);
                        break;
                    case "noMoveToLocker":
                        pi.setAllowOverlappedSet(parseInt(value) != 0);
                        break;
                    case "allowOverlappedSet":
                        pi.setAllowOverlappedSet(parseInt(value) != 0);
                        break;
                    case "noRevive":
                        pi.setNoRevive(parseInt(value) != 0);
                        break;
                    case "noScroll":
                        pi.setNoScroll(parseInt(value) != 0);
                        break;
                    case "autoBuff":
                        pi.setAutoBuff(parseInt(value) != 0);
                        break;
                    case "multiPet":
                        pi.setAutoBuff(parseInt(value) != 0);
                        break;
                    case "autoReact":
                        pi.setAutoReact(parseInt(value) != 0);
                        break;
                    case "pickupAll":
                        pi.setPickupAll(parseInt(value) != 0);
                        break;
                    case "sweepForDrop":
                        pi.setSweepForDrop(parseInt(value) != 0);
                        break;
                    case "consumeMP":
                        pi.setConsumeMP(parseInt(value) != 0);
                        break;
                    case "evol":
                        pi.setEvol(parseInt(value) != 0);
                        break;
                    case "starPlanetPet":
                        pi.setStarPlanetPet(parseInt(value) != 0);
                        break;
                    case "cash":
                        pi.setCash(parseInt(value) != 0);
                ...
                for (Node mainNode : XMLApi.getAllChildren(nodes.get(0))) {
                            ...
                            switch (name) {
                                ...
                                case "skill":
                                    for (Node masteryBookSkillIdNode : XMLApi.getAllChildren(info)) {
                                        item.addSkill(parseInt((XMLApi.getNamedAttribute(masteryBookSkillIdNode, "value"))));
                                    }
                                    break;
                                case "reqSkillLevel":
                                ...
                                case "questId":
                                    if (value.contains(".") && value.split("[.]").length > 0) {
                                        item.addQuest(parseInt(value.split("[.]")[0]));
                                    } else {
                    ...
                    if (reqNode != null) {
                        for (Node req : XMLApi.getAllChildren(reqNode)) {
                            ...
                            item.getReqItemIds().add(parseInt(value));
                        }
                    }
                    ...
                    if (socket != null) {
                        for (Node socketNode : XMLApi.getAllChildren(socket)) {
                            ...
                            switch (name) {
                                case "optionType":
                                    item.putScrollStat(optionType, parseInt(value));
                                    break;
                            }
                        }
                        ...
                        if (XMLApi.getNamedAttribute(level, "value") != null) {
                            ssVal = parseInt(XMLApi.getNamedAttribute(level, "value"));
                        }
                        ...
                        for (Node specNode : XMLApi.getAllChildren(spec)) {
                            ...
                            switch (name) {
                                case "script":
                                    ...
                                    break;
                                case "npc":
                                    item.setScriptNPC(parseInt(value));
                                    break;
                                case "moveTo":
                                    item.setMoveTo(parseInt(value));
                                    break;
                                default:
                                    SpecStat ss = SpecStat.getSpecStatByName(name);
                                    if (ss != null && value != null) {
                                        item.putSpecStat(ss, parseInt(value));
                                    } else if (LOG_UNKS){
                    ...
                    if (reward != null) {
                        for (Node rewardNode : XMLApi.getAllChildren(reward)) {
                            ...
                            for (Node rewardInfoNode : XMLApi.getAllChildren(rewardNode)) {
                                ...
                                switch (name) {
                                    case "count":
                                        iri.setCount(parseInt(value));
                                        break;
                                    case "item":
                                        iri.setItemID(parseInt(value));
                                        break;
                                    case "prob":
                                        iri.setProb(Double.parseDouble(value));
                                        break;
                                    case "period":
                                        iri.setPeriod(parseInt(value));
                                        break;
                                    case "effect":
                                    case "Effect":
                                        iri.setEffect(value);
    ...
    public static void loadMountItemsFromFile() {
        ...
        try (Scanner scanner = new Scanner(new FileInputStream(file))) {
            while(scanner.hasNextLine()) {
                ...
                int itemId = parseInt(lineSplit[0]);
                int skillId = parseInt(lineSplit[1]);
        ...
        for (Node mainNode : XMLApi.getAllChildren(nodes.get(0))) {
            ...
            if (infoNode != null) {
                for (Node infoChild : XMLApi.getAllChildren(infoNode)) {
                    ...
                    switch (name) {
                        case "optionType":
                            io.setOptionType(parseInt(value));
                            break;
                        case "weight":
                            io.setWeight(parseInt(value));
                            break;
                        case "reqLevel":
                            io.setReqLevel(parseInt(value));
                            break;
                        case "string":
                            io.setString(value);
                            break;
            ...
            if (levelNode != null) {
                for (Node levelChild : XMLApi.getAllChildren(levelNode)) {
                    int level = parseInt(XMLApi.getNamedAttribute(levelChild, "name"));
                    for (Node levelInfoNode : XMLApi.getAllChildren(levelChild)) {
                        ...
                        switch (name) {
                            ...
                            case "boss":
                                ...
                                if (incDamgNode != null) {
                                    value = parseInt(XMLApi.getNamedAttribute(incDamgNode, "value"));
                                }
    ...
    private static Set<Integer> searchForStartingItems(Node n) {
        ...
        for (Node node : subNodes) {
            ...
            if (Util.isNumber(name) && value != null && Util.isNumber(value)) {
                startingItems.add(parseInt(value));
            }
